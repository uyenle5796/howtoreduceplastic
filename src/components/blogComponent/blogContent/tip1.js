    ...
    return (
      <div>
        ...
        <div className="post-content">
          ...
          Combined with our "throw away" culture, every day millions of them are consumed, but not enough effort has been made to recycle or reuse them fast enough.
          This makes single use plastic a major contributor to plastic waste and pollution to the environment.
          <br/><br/>
          Therefore, the first and most important step to your reducing plastic journey is to learn to <b>say no to all single-use plastics</b>.
          ...
          <br/>These are tips that have now become a habit to me. It may be daunting when you first start doing them, but trust me, keep them in your mind and one day you'll be doing them without even knowing it!
