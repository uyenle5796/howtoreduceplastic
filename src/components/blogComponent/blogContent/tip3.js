    ...
    return (
      <div>
        ...
        <div className="post-content">
          Many items in the supermarket can be bought without packaging, especially fresh produce such as fruits and vegetables,
          thanks to their own natural skin. So next time you go shopping, try to opt for <b>package-free versions</b>.
          This also helps you buy only as much as you need and <b>reduce food waste</b>. Some examples are:
          <br/><br/>
