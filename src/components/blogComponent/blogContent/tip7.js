    ...
    return (
      <div>
        ...
        <div className="post-content">
          ...
          <br/>
          <h4>Recycle the "unrecyclable" with <a href="https://www.terracycle.com">Terracycle</a></h4>
          Luckily, many items in the Trash bin may not end up in landfill, as many packaging with "unrecyclable" labels can actually still be recycled in some parts. Terracycle offers a range of <a href="https://www.terracycle.com/en-GB/brigades">free recycling programmes</a> that
          recycle almost everything that you think is unrecyclable, from chocolate wrappers, snack wrappers to beauty products packaging. All you need to do is signup for an account, then drop-off your packaging at their drop-off locations throughout UK or post your packaging for free using pre-paid labels.
          <br/>
          <b>Note:</b> Make sure you check the recycling centres near you first, as they may already be recycling these packaging.
          <br/><br/>

          <h4>Find a recycling centre near you</h4>
          Use the interactive map below for all recycling centres in UK and find the one near you:
          <br/><br/>
